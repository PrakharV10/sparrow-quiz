        ...
        <div className="bg-black-800 w-screen min-h-screen h-full">
            ...
            <main className="w-full">
                ...
                <section className="w-4/5 max-w-xs text-center m-auto mb-16 lg:max-w-lg lg:mb-10">
                    <p className="text-lg font-light text-white-100 lg:opacity-80">Congratulations on completing the Quiz!! Share your Victory with your friends, and challenge them to beat your score!!</p>
                </section>
                ...
                <section className="flex justify-between items-center w-56 m-auto mb-10 lg:mb-10">
                    ...
                    >
                        <img src={Twitter} alt="twitter-logo" className="outline-none" style={{ width : "42px", height: "34px"}} />
                    </TwitterShareButton>
                    ...
                    <FacebookShareButton
                        ...
                        url="https://sparrow-store.netlify.app"
                    >
                        <img src={Facebook} alt="facebook-logo" style={{ width: "42px", height: "42px" }} />
                    </FacebookShareButton>
                    ...
                    <WhatsappShareButton
                        ...
                        title={`Hey Everyone! I just got 320 points, in the friends quiz on sparrow. I challenge you all to beat my score!!\nTry it out here -`}
                    >
                        <img src={Whatsapp} alt="facebook-logo" style={{ width: "44px", height: "44px" }} />
                    </WhatsappShareButton>    
                </section>

                <section className="text-center">
                    <button className="btn bg-blue-700 rounded-sm w-28 h-10 min-w-0 mb-4 lg:w-36 lg:h-12 lg:font-bold lg:text-lg">CONTINUE</button>
                </section>
            </main>
        </div>
    )
